...
@SupportedAnnotationTypes("io.ashimjk.annotationprocessor.sample.BuilderProperty")
...
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (TypeElement annotation : annotations) {
            ...
            Map<Boolean, ? extends List<? extends Element>> annotatedMethods = annotatedElements.stream()
                    .collect(
            ...
            ofNullable(annotatedMethods.get(false))
                    .ifPresent(otherMethods ->
            ...
            ofNullable(annotatedMethods.get(true))
                    .ifPresent(setters -> {
